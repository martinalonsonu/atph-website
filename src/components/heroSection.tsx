        ...
        <section className='w-full h-auto lg:h-[720px] flex flex-col lg:flex-row bg-[#f5faff]'>
            ...
            <div className='flex flex-col lg:w-[100%] flex-1'>
                <div className='w-full h-full flex flex-col px-4 py-6 sm:py-14 sm:pl-24 justify-center gap-8 relative overflow-hidden'>
                    ...
                    <p className='text-[15px] sm:text-2xl max-w-[280px] sm:max-w-[520px] font-mulish'>Nacimos del deseo sincero de servir a Dios y de poner nuestros dones al servicio de los demás. Inspirados por nuestra fe, decidimos llevar nuestras devociones a través del mundo digital.</p>
