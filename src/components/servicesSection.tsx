        ...
        <div className='w-full sm:gap-10 sm:max-w-[1000px] xl:max-w-[1200px] flex flex-col xl:gap-0 lg:flex-row mx-auto justify-center items-center py-6 px-4 lg:px-0 lg:py-20'>
            <div className='w-full flex flex-col items-center lg:w-[50%] relative'>
                <div className='w-full mb-9 xl:ml-24'>
                    <p className='font-work text-base sm:text-xl font-bold text-[#cca21c] sm:mb-2.5'>¿QUÉ HACEMOS?</p>
                    <h3 className='font-cinzel text-2xl sm:text-4xl lg:text-6xl font-bold text-[#54290c]'>NUESTROS SERVICIOS</h3>
                </div>
            ...
            <div className='w-full lg:w-[50%] flex flex-col items-center mt-10 sm:mt-0 gap-9 lg:gap-24'>
                <CardService image='/assets/services-2.jpg' alt='Portada' title='Alfombras' description='Nos especializamos en el diseño y elaboración de alfombras artísticas utilizando aserrín y viruta teñida. Estas creaciones, llenas de color y simbolismo, son ideales para celebraciones religiosas y procesiones. Cada alfombra es realizada con dedicación y detalle, reflejando la riqueza de nuestras tradiciones.'/>
